...
public class UsuarioController {
	...
	public String executeTelaGerenciaUsuario(@Valid Usuario usuario, BindingResult result){
	...
	public ModelAndView adiciona(@Valid Usuario usuario, BindingResult result){
			...
			if(usuarioDAO.adiciona(usuario)){
				ModelAndView mv = new ModelAndView("redirect:/gerenciausuario", "sucesso", "Usuario cadastrado com sucesso");
				return mv;
			}else{
				ModelAndView mv = new ModelAndView("redirect:/gerenciausuario", "erro", "Erro ao cadastrar usuario");
				return mv;
			}
	}
