        ...
        <form id="formlogin" action="adicionacurso" method="POST">
                <div class="panel-body">  
                    ...
                    <div class="form-group">
                            <input type="text" class="form-control" placeholder="Codigo" name="cod_curso"/>
                    </div>
                    
                    <div class="form-group">
                            <input type="text" class="form-control" placeholder="Nome" name="nome_curso"/>
                    </div>  
            ...
            <button class="btn btn-sm btn-info btn-block" type="submit" >Adicionar</button>
        </form>
    </div>
    </div>
  </div>
