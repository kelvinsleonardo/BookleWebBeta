            ...
            <div role="main">
                <div class="col-md-12 col-md-offset-0">
                    ...
                    <div class="col-md-offset-9">
                        <br>
                        <button type="submit" class="btn btn-info btn-sm form-control" data-toggle="modal" data-target="#modalAdicionaLivro"/><span class="glyphicon glyphicon-plus-sign"></span> &nbsp;Adicionar Livro</button>
                    </div>
